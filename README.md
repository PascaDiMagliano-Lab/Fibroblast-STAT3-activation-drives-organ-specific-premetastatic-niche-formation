...
This repository includes code used for data processing and visualization of single cell RNA sequencing data from the manuscript "<a href="https://aacrjournals.org/cancerres/article/86/1/22/771158/Fibroblast-STAT3-Activation-Drives-Organ-Specific">Fibroblast STAT3 activation drives organ-specific premetastatic niche formation</a>". Raw data files for the novel datasets generated in this manuscript are available through the NIH Gene Expression Omnibus (GEO), accession number <a href="https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE292712">GSE292712</a>.
